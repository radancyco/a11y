 ...
 */
  ...
  const loadLanguagePack = (url, callback) => {
    ...
    const getComponentLanguagePack = shadowContainer.getElementById("component-library-language-pack");
  ...
  const initAccordion = () => {
    ...
    loadLanguagePack("https://services.tmpwebeng.com/component-library/language-pack.js", () => {
      ...
      console.log("%c Accordion v2.8 in use. ", "background: #6e00ee; color: #fff");
