javascript:(function() {
  (async () => {
    ...
    const userPrompt = prompt(
      "Enter a custom AI prompt for alt text generation.\nClick Cancel to use the default prompt."
    );

    // Default prompt if user cancels or leaves blank
    const defaultPrompt = "Generate a concise, meaningful alt text for this image that conveys only the essential content and purpose. " +
